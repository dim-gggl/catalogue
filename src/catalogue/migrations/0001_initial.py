    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('reference_type', models.CharField(choices=[('EXHIBITION_CATALOGUE', "Catalogue d'exposition"), ('ALBUM', 'Album BD'), ('BOOK', 'Ouvrage critique'), ('MAGAZINE', 'Magazine'), ('OTHER', 'Autre')], default='OTHER', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Signé', models.BooleanField(choices=[('Oui', 'True'), ('Non', 'False')], default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artwork', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='wishlisted_by', to='catalogue.artwork')),
